    ...
    <div class="py-6">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-4 flex justify-end">
                <a href="{{ route('gear-item-categories.create') }}"
                    ...
                    <tbody>
                        @forelse ($categories as $category)
                            <tr class="border-t">
                                ...
                                <td class="px-4 py-2">
                                    <a href="{{ route('gear-item-categories.show', $category) }}"
                                ...
                                <td class="px-4 py-2 text-right whitespace-nowrap">
                                    <a href="{{ route('gear-item-categories.edit', $category) }}"
                                    ...
                                    <form action="{{ route('gear-item-categories.destroy', $category) }}" method="POST"
                                        class="inline"
